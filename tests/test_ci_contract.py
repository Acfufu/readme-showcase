...
class CiContractTests(unittest.TestCase):
    ...
    def test_elk_lanes_are_pinned_read_only_and_network_isolated(self) -> None:
        ...
        self.assertIn('NPM_CONFIG_CACHE="${HOME}/.npm"', self.workflow)
    ...
    def test_compiled_visual_kernel_lane_is_matrix_pinned_and_offline(self) -> None:
        ...
        self.assertIn("tests.test_pipeline_contracts", self.workflow)
        ...
        self.assertIn("tests.e2e.test_preview_report", self.workflow)
        self.assertIn("tests.e2e.test_resumable_pipeline", self.workflow)
