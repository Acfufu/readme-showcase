...
class EvidenceV2ContractTests(unittest.TestCase):
    ...
    def test_draft_2020_12_schema_executes_over_valid_and_structural_invalid_cases(self) -> None:
        ...
        structurally_invalid = {"mixed-locator", "source-hash", "bad-json-pointer", "voice-sample-derived-without-derivation", "voice-sample-float-value", "visual-fact-float-value"}
