...
_RETRIEVAL_SERVICE = importlib.import_module(
    "readme_showcase.retrieval.service"
    if __package__ in (None, "")
    else "skill.scripts.readme_showcase.retrieval.service"
)
...
_EVALUATION = importlib.import_module(
    "scripts.readme_showcase.evaluation"
    if __package__ in (None, "")
