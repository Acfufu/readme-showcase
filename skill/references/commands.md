...
| Narrow refinement | "polish the quick-start section" | `polish [target]` — README mode, target as hard scope boundary; stops at the smallest relevant local diff and checks |
